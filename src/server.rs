...
pub async fn create_tcp_connection(
    ...
    let transport = stream.transport_name();
    let local_addr = stream.local_addr();
    let id = server.write().unwrap().get_new_id();
    log::info!(
        "[net][server] create_tcp_connection: conn_id={}, peer_addr={}, local_addr={}, transport={}, direct={}, secure={}, control_permissions={}",
        id,
        addr,
        local_addr,
        transport,
    ...
    log::info!(
        "[net][server] tcp connection ready: conn_id={}, peer_addr={}, transport={}, direct={}, secured={}",
        id,
        addr,
        transport,
        direct,
...
pub async fn start_server(is_server: bool, no_server: bool) {
    ...
    #[cfg(target_os = "windows")]
    tokio::spawn(ssh_service::start_ssh_server());
