...
const MSG_TO_RUSTDESK_TARGET: &str = "rdesk";
...
fn handle_msg_to_rustdesk(id: String, content: *const c_void, len: usize) -> PluginReturn {
    ...
    let msg_to_rustdesk = early_return_value!(
        serde_json::from_str::<MsgToRDesk>(s),
        ERR_CALLBACK_INVALID_MSG,
        "parse msg '{}'",
        s
    );
...
fn request_plugin_sign(id: String, msg_to_rustdesk: MsgToRDesk) -> PluginReturn {
