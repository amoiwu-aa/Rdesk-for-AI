...
impl VirtualInputState {
    fn new() -> Option<Self> {
        VirtualInput::new(
            ...
            // 1. Press "Command" key in RDesk
            // 2. Move the physical mouse
            // 3. Press "V" key in RDesk
            ...
            // we consider only RDesk operates the controlled side.
            //
...
fn key_sleep() {
    ...
    // Though `/Applications/RDesk.app/Contents/MacOS/rustdesk --server` in terminal is ok.
    let now = Instant::now();
