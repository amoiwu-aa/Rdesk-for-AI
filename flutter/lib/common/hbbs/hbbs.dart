...
class UserPayload {
  ...
  static Map<String, dynamic>? _normalizeMembership(dynamic raw) {
  ...
  UserPayload.fromJson(Map<String, dynamic> json)
      : name = json['name'] ?? '',
        ...
        membership = _normalizeMembership(json['membership']) ??
            _normalizeMembership(
                json['user'] is Map ? (json['user'] as Map)['membership'] : null),
