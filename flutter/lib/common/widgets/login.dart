        ...
        child: Column(
          ...
          children: [
            ...
            CheckboxListTile(
              ...
              title: Text(translate('remember_account_tip')),
              onChanged: isInProgress ? null : (v) => onRememberAccountChanged(v ?? false),
            ),
            CheckboxListTile(
              dense: true,
              visualDensity: VisualDensity.compact,
              ...
              onChanged: isInProgress || !rememberAccount
                  ? null
                  : (v) => onRememberPasswordChanged(v ?? false),
            ),
            CheckboxListTile(
              dense: true,
              visualDensity: VisualDensity.compact,
              ...
              onChanged: isInProgress || !rememberPassword
                  ? null
                  : (v) => onAutoLoginChanged(v ?? false),
            ),
...
Future<bool?> loginDialog() async {
  final savedUsername = UserModel.getSavedUsername();
  final savedPassword = UserModel.getSavedPassword();
  var username = TextEditingController(
      text: savedUsername.isNotEmpty
          ? savedUsername
          : (UserModel.getLocalUserInfo()?['name'] ?? ''));
  var password = TextEditingController(text: savedPassword);
  ...
  var rememberAccount = UserModel.getRememberAccount();
  var rememberPassword = UserModel.getRememberPassword();
  var autoLogin = UserModel.getAutoLogin();
        ...
        case HttpType.kAuthResTypeToken:
          if (resp.access_token != null) {
            if (storeIfAccessToken) {
              await UserModel.saveLoginPreferences(
              ...
              await gFFI.userModel.storeTokens(resp);
      ...
      content: Column(
        ...
        children: [
          ...
          LoginWidgetUserPass(
            ...
            onAutoLoginChanged: (v) => setState(() => autoLogin = v),
            curOP: curOP,
            onLogin: onLogin,
