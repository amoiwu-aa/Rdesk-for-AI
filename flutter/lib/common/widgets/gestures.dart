...
class CustomTouchGestureRecognizer extends ScaleGestureRecognizer {
  ...
  // Fixed: Cancel previous debounce timer before starting new gesture detection.
  // The old logic would lose oneFingerPan events when fingers moved fast because
  // the debounce timer from the previous gesture end was still pending.
