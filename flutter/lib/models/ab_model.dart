...
class AbModel {
  ...
  bool get addressBookProEnabled =>
      gFFI.userModel.hasMembershipFeature('address_book_pro');

  bool canUseAdvancedAddressBook() => addressBookProEnabled;
