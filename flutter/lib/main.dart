...
import 'package:flutter_hbb/desktop/screen/desktop_ai_assistant_screen.dart';
  ...
  if (args.isNotEmpty && args.first == 'multi_window') {
    ...
    switch (kWindowType) {
      ...
      case WindowType.AiAssistant:
        desktopType = DesktopType.aiAssistant;
        runMultiWindow(
          argument,
          'ai-assistant',
        );
...
void runMultiWindow(
  ...
  switch (appType) {
    ...
    case kAppTypeDesktopTerminal:
      ...
      break;
    case 'ai-assistant':
      widget = DesktopAiAssistantScreen(
        params: argument,
      );
      break;
    default:
  ...
  switch (appType) {
    ...
    case kAppTypeDesktopTerminal:
      ...
      break;
    case 'ai-assistant':
      await restoreWindowPosition(WindowType.AiAssistant, windowId: kWindowId!);
      break;
    default:
      // no such appType
      exit(0);
