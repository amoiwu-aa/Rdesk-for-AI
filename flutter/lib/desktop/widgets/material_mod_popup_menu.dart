      ...
      builder: (BuildContext context, Widget? child) {
        return FadeTransition(
          ...
          child: Material(
            ...
            child: ClipPath(
              clipper: ShapeBorderClipper(shape: route.shape ?? popupMenuTheme.shape ?? const RoundedRectangleBorder()),
              child: BackdropFilter(
                filter: ImageFilter.blur(sigmaX: 15.0, sigmaY: 15.0),
                child: Container(
                  color: (route.color ?? popupMenuTheme.color ?? Theme.of(context).cardColor).withOpacity(Theme.of(context).brightness == Brightness.dark ? 0.65 : 0.8),
                  child: Align(
