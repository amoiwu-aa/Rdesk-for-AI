pub use crate::dxgi::OwnedTextureFrame;
#[cfg(feature = "vram")]
...
impl Capturer {
    ...
    pub fn owned_texture_frame(&mut self, timeout: Duration) -> io::Result<OwnedTextureFrame> {
        self.inner.owned_texture_frame(timeout.as_millis() as _)
    }
}
...
impl TraitCapturer for Capturer {
    ...
    fn owned_texture_frame(&mut self, timeout: Duration) -> io::Result<OwnedTextureFrame> {
        self.inner.owned_texture_frame(timeout.as_millis() as _)
    }
}
